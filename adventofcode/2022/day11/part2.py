...
def get_monkey_details(input_lines):
    ...
    for i in range(len(input_lines) // 7):
        ...
        modulus *= div_factor
    return monkey_details, modulus


def main(input_lines):
    monkey_details, modulus = get_monkey_details(input_lines)
    for _ in range(10000):
        for monkey_detail in monkey_details:
            ...
            for item in monkey_detail["items"]:
                ...
                # We have to decrease the worry_level
    ...
    largest = heapq.nlargest(2, [m["count"] for m in monkey_details])
